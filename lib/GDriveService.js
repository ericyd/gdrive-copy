...
/**
 * Call functions from queue.
 * Throttled to 1 call per 100ms to avoid Google Quotas.
 */
GDriveService.prototype.callNext = Util.throttle(function() {
  if (this._queue.length > 0) {
    var nextFunc = this._queue.pop();
    return nextFunc();
  }
});

/**
 * Add function to queue, and call next function from queue
 */
GDriveService.prototype.rateLimiter = function(func) {
 ...
 * This isn't terribly efficient, but should be functional
 */
GDriveService.prototype.clearQueue = function () {
