...
Util.cleanup = function(properties, fileList, userProperties, timer, ss) {
  // increment totalRuntime
  userProperties.setProperty('totalRuntime', userProperties.getProperty('totalRuntime') + timer.runtime);
  ...
  if (timer.stop) {
    ...
    userProperties.setProperty('totalRuntime', 0);
  }
