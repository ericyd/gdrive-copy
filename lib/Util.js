...
// credit: https://underscorejs.org/docs/underscore.html
...
Util.throttle = function(func, wait, options) {
  // Google API quota is 1000 reqs per 100 seconds.
  // Therefore, 100ms wait time should ensure 10 reqs/sec max
  var wait = wait || 100;
