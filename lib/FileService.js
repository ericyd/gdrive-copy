...
// FileService.prototype.setGDrive = function(gdrive) {
//   this.gdrive = gdrive;
// }
 ...
 */
FileService.copyFile = function(file, map, properties) {
...
FileService.processFileList = function(
  ...
  while (items.length > 0 && timer.canContinue()) {
    ...
    try {
      var newfile = FileService.copyFile(item, map, properties);
...
FileService.composeErrorMsg = function(e) {
  return (
    'Error: ' + e.message + '. File: ' + e.fileName + '. Line: ' + e.lineNumber
  );
};
